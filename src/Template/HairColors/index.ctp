 ...
 * @var \App\Model\Entity\HairColor[]|\Cake\Collection\CollectionInterface $hairColors
 */
?>
...
<div class="hairColors index large-9 medium-8 columns content">
    <h3><?= __('Hair Colors') ?></h3>
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= h($hairColor->status) ?></td>
                <td><?= h($hairColor->created) ?></td>
                <td><?= h($hairColor->modified) ?></td>
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $hairColor->id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $hairColor->id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $hairColor->id], ['confirm' => __('Are you sure you want to delete # {0}?', $hairColor->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
