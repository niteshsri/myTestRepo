 ...
 * @method \App\Model\Entity\UserLike newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\UserLike[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\UserLike|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\UserLike patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\UserLike[] patchEntities($entities, array $data, array $options = [])
...
class UserLikesTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->integer('liker_identifier')
            ->requirePresence('liker_identifier', 'create')
            ->notEmpty('liker_identifier');
